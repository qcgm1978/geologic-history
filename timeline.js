...
$(document).ready(function() {
  ...
  showAbout = async function() {
    ...
    const name = $(this)
      ...
      .trim()
      .split(/\s+/)[0];
    const arr = await getBornDate(name);
    ...
    $next
      ...
      .remove("img")
      .end()
      .append(`<img src='${arr[0].image}' width=300>`);
    $next.show();
    return false;
  };
  hideAbout = function() {
  ...
  $("dt")
    .bind("mouseover", showAbout)
    .bind("mouseout", hideAbout);
  $(".translatable").hover(
    function() {
      $(this)
        .children()
  ...
  $("#make-plain").click(function() {
    ...
    $("dt")
      .unbind("mouseover", showAbout)
      .unbind("mouseout", hideAbout);
  });
